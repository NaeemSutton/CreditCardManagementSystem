...
public:
    ...
    */
    ...
    //You have to create another func in public to return the root
    Binary_Tree<Item_Type> get_root() const {
        return Binary_Tree<Item_Type>(root);
    }
...
protected:
    ...
    explicit Binary_Tree(BTNode<Item_Type>* new_root) : root(new_root) {}
