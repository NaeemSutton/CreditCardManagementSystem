...
public:
    ...
    */
    ...
    //Item_Type* Binary_Search_Tree<Item_Type>::find(BTNode<Item_Type>* current, const string& card_number)
...
Binary_Search_Tree<Item_Type>::replace_parent(BTNode<Item_Type>*& old_root,
    ...
    if (local_root->right != NULL) {
        ...
        old_root = local_root;
        local_root = local_root->left;  // set it's parent to its left child.
    }
}
